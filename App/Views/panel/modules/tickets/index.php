                    ...
                    <div class="card-header border-bottom pb-0">
                        <div class="d-sm-flex align-items-center">
                            ...
                            <div class="ms-auto d-flex">
                                <a type="button" href="../Ticket/create" class="btn btn-sm btn-dark btn-icon d-flex align-items-center me-2">
                                    <iconify-icon icon="mingcute:user-add-2-fill" width="20" height="20" style="color: white"></iconify-icon>
                                    <span class="btn-inner--text">Crear Ticket</span>
                                </a>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table align-items-center mb-0">
                                <thead class="bg-gray-100">
                                    <tr>
                                        ...
                                        <th class="text-center text-secondary text-xs font-weight-semibold opacity-7">ID Historia de usuario</th>
